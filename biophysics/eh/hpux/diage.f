...
c
      subroutine dcsevu (x,y,nx,c,ic,u,ds,m1,dds,m2,ier,ndim)
c----------------------------------------------------------------------
c
...
c
      implicit real*8(a-h,o-z)
      dimension x(ndim),y(ndim),c(ndim,3),u(1),ds(1),dds(1)
c
...
c                                  if u(i) .gt. x(nx) - warning
 ...
 9000 continue
      if (jer .gt. 0)  then
           write(6,*)  '   dcsevu:    jer.ne.0,    jer=',jer
           stop
      endif
      if (ker .gt. 0)  then
           write(6,*)  '   dcsevu:    ker.ne.0,    ker=',ker
           stop
      endif
 9005 return
      end
