      ...
      subroutine rk4(tau,n,psi,time,nstp,tmd,vtr,vti,cvr,cvi)

c Fourth-order Runge-Kutta method

      implicit real*8 (a-h,o-z)
      parameter(nmax=500,nsmp=10)
...
c...f4
	 ...
	 enddo
      ...
      subroutine saverkns(n,time,psi)
...
c save wave function
      ...
      open(99,file='SAVENS.CONT',status='unknown',form='unformatted')
	 ...
	 write(99) psi(i)
      ...
      subroutine readrkns(n,time0,psi0)
...
c read wave function
      ...
      open(99,file='SAVENS.CONT',status='old',form='unformatted')
