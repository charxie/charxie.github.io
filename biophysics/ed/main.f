...
c turn some part of kmatrix off
 ...
 3434          	       continue
              ...
              call dyneigen(mstp,tau,ndim,teg,eg,ev,ft,neign,tmd,h,cof)
c              call dyneigen(mstp,tau,ndim,teg,eg,ev,ft,neign)
              stop
           endif
...
c>>> check the bridge eigenstates
	      ...
	      stop
           ...
           if(new2s) then
              ...
              do n = 1 , nstp
                 ...
                 if(zr(idon,neign-1).gt.0.0) then
     ...
     *                   +zr(idon,neign  )**2*zr(iacc,neign  )**2/ss2**4
                 write(6,*) sumover1,sumover2,sumover1/sumover2
     ...
     *              omcm(neign-2),omcm(neign+1)
	      ...
	      call tsa(tau,nstp,tmd,h2s,pdir,pinv)
	      stop
