	...
	return
       	...
       	subroutine interpol2(nstp,ndim,tmd,h,cof)
	implicit real*8(a-h,o-z)
	real*4 tmd(nstp),h(ndim,nstp),cof(ndim,nstp,3)
	real*4 hij(nstp),cofij(nstp,3)
        common /io/ iin,iout
...
C D,INDX FOR INTERNAL USE
      ...
      IMPLICIT REAL*8 (A-H,O-Z)
      PARAMETER (NMAX=248,TINY=1.0D-20)
