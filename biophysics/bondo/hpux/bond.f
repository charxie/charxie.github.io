     ...
     $T2J(NBSZR)
      ...
      DATA ELNG/2.75D0,0.0D0,0.97D0,1.47D0,2.01D0,2.5D0,3.07D0,3.5D0,4.1        
     1D0,0.0D0/                                                                 
      DATA LBD,LBDS,LLPR,LP1,LP1S,LP2,LP2S/'BD','BD*','LPR','P1','P1*',         
     + 'P2','P2*'/                                                              
      DO 10 I=1,NO                                                              
   10 T2J(I)=0.0D0                                                              
      ITYPE=1                                                                   
...
C  SECOND PI BOND                                                               
  140 CONTINUE                                                                  
      NUM=4                                                                     
      NUM2=4                                                                    
      IF((LBL.NE.LP2).AND.(LBL.NE.LP2S)) CALL ABORT('PI ORB')                   
  150 CONTINUE                                                                  
